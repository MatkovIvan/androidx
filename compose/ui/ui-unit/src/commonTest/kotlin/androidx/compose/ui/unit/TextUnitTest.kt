...
class TextUnitTest {
    ...
    @Test
    fun minus_unspecified() = expectException<RuntimeException> {
    ...
    @Test
    fun multiply_unspecified_float() = expectException<RuntimeException> {
        TextUnit.Unspecified * 3f
    }

    @Test
    fun multiply_unspecified_double() = expectException<RuntimeException> {
        TextUnit.Unspecified * 3.0
    }

    @Test
    fun multiply_unspecified_int() = expectException<RuntimeException> {
        TextUnit.Unspecified * 3
    }

    @Test
    fun multiply_float_unspecified() = expectException<RuntimeException> {
        3f * TextUnit.Unspecified
    }

    @Test
    fun multiply_double_unspecified() = expectException<RuntimeException> {
        3.0f * TextUnit.Unspecified
    }

    @Test
    fun multiply_int_unspecified() = expectException<RuntimeException> {
    ...
    @Test
    fun compare_sp_em() = expectException<RuntimeException> {
        1.sp > 2.em
    }

    @Test
    fun compare_em_sp() = expectException<RuntimeException> {
        1.em > 2.sp
    }

    @Test
    fun compare_unspecified_sp() = expectException<RuntimeException> {
        TextUnit.Unspecified > 2.sp
    }

    @Test
    fun compare_sp_unspecified() = expectException<RuntimeException> {
        1.sp > TextUnit.Unspecified
    }

    @Test
    fun compare_unspecified_em() = expectException<RuntimeException> {
        TextUnit.Unspecified > 2.em
    }

    @Test
    fun compare_em_unspecified() = expectException<RuntimeException> {
        1.em > TextUnit.Unspecified
    }

    @Test
    fun compare_unspecified_unspecified() = expectException<RuntimeException> {
    ...
    @Test
    fun testIsSpecified() {
        assertFalse(TextUnit.Unspecified.isSpecified)
        assertTrue(1.sp.isSpecified)
    }

    @Test
    fun testIsUnspecified() {
        assertTrue(TextUnit.Unspecified.isUnspecified)
        assertFalse(1.sp.isUnspecified)
    }

    @Test
    fun testTakeOrElseTrue() {
        assertTrue(1.sp.takeOrElse { TextUnit.Unspecified }.isSpecified)
    }

    @Test
    fun testTakeOrElseFalse() {
        assertTrue(TextUnit.Unspecified.takeOrElse { 1.sp }.isSpecified)
    }
}

private inline fun <reified T : Exception> expectException(block: () -> Unit) {
    try {
        block()
        fail("Expected exception")
    } catch (e: Exception) {
        assertThat(e).isInstanceOf<T>()
    }
}
