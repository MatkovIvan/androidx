...
downloadLinuxSDK() {
    ...
    echo y | "fullsdk-linux/cmdline-tools/bin/sdkmanager" --sdk_root=fullsdk-linux "platform-tools" "platforms;android-$ANDROID_COMPILE_SDK" "build-tools;$ANDROID_BUILD_TOOLS" "ndk;$ANDROID_NDK"
...
downloadMacOsSDK() {
    ...
    echo y | "fullsdk-darwin/cmdline-tools/bin/sdkmanager" --sdk_root=fullsdk-darwin "platform-tools" "platforms;android-$ANDROID_COMPILE_SDK" "build-tools;$ANDROID_BUILD_TOOLS" "ndk;$ANDROID_NDK"
